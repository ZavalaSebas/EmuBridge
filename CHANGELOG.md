...
### Known Issues
- 14 of 15 seed platforms have no `KnownEmulatorCore` entry yet — the install mechanism itself is now proven end-to-end (see ARCHITECTURE.md → ADR-14), this is a data-sourcing gap, not a mechanism gap (see DEVELOPMENT.md → Known Limitations)
