...
// Fetches/manages per-game RetroArch .cht files (ARCHITECTURE.md -> ADR-27). Bridge never curates
...
public class CheatService : ICheatService
{
    ...
    // toggle-gated - it's written whenever a Bridge-managed cheat file exists for this game,
