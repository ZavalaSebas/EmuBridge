...
public interface ICheatService
{
    ...
    // whether this game has a EmuBridge-managed cheat file at all. Never triggers a fetch; null means
    // no EmuBridge-managed cheat file exists for this game yet, so RetroArch's own defaults are left
