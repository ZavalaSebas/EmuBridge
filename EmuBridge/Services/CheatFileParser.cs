...
// a third-party guide. EmuBridge only ever needs cheatN_desc/cheatN_enable per entry to show a
...
public static class CheatFileParser
{
    ...
    public static CheatParseResult Parse(string rawText)
    {
        ...
        for (var i = 0; i < count; i++)
        {
            ...
            {
                // Reject the whole file rather than show a partial list — an entry EmuBridge can't
