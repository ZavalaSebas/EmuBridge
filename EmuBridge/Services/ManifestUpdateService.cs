...
// Keeps EmuBridge's emulator/core catalog current between releases without waiting for a new
// EmuBridge.exe build — see ARCHITECTURE.md -> ADR-25 for the full design and the reconciliation
// with ADR-11's original rejection of a live-fetched manifest. Fetches EmuBridge's own
...
// deliberate exception to EmuBridge's usual never-fail-silently rule (see DEVELOPMENT.md -> Bug
