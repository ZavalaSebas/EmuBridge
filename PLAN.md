...
19. An interactive pass on the new "Auto-Install" button itself — it's proven at the orchestration/unit-test level (real archive extraction, real DI resolution) but nobody has clicked it in a running window yet.
