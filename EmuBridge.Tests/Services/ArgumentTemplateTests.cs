...
public class ArgumentTemplateTests
{
    ...
    [Fact]
    public void Validate_TemplateWithoutRomPathToken_ThrowsEmuBridgeException()
    {
        Assert.Throws<EmuBridgeException>(() => ArgumentTemplate.Validate("-fullscreen"));
    }
    ...
    [Fact]
    public void Expand_UnknownToken_ThrowsEmuBridgeException()
    {
        Assert.Throws<EmuBridgeException>(() => ArgumentTemplate.Expand("{RomPath} {Unknown}", @"C:\roms\mario.nes"));
    }

    [Fact]
    public void Expand_MissingRequiredToken_ThrowsEmuBridgeException()
    {
        Assert.Throws<EmuBridgeException>(() => ArgumentTemplate.Expand("-fullscreen", @"C:\roms\mario.nes"));
    }
    ...
    [Fact]
    public void Expand_CorePathTokenInTemplateButNoCorePathSupplied_ThrowsEmuBridgeException()
    {
        Assert.Throws<EmuBridgeException>(() => ArgumentTemplate.Expand("-L {CorePath} {RomPath}", @"C:\roms\mario.nes"));
    }
}
